...
class MovieRepositoryImpl @Inject constructor(
    ...
    override suspend fun fetchPopularMovies(): List<Movie> = networkDataSource.popularMovies()

    override suspend fun fetchTopRatedMovies(): List<Movie> = networkDataSource.topRatedMovies()

    override suspend fun fetchReviews(movieId: String): List<Review> =
        networkDataSource.reviews(movieId)

    override suspend fun fetchTrailers(movieId: String): List<Trailer> =
        networkDataSource.trailers(movieId)
    ...
    override suspend fun deleteFavoriteMovie(movie: Movie) = localDataSource.deleteMovie(movie)

    override suspend fun deleteAllFavoriteMovies() = localDataSource.deleteAllMovies()
}
